...
export default function Price() {
  const [activeTab, setActiveTab] = useState<0 | 1>(0); // 0 for 3 BHK, 1 for 4 BHK on mobile
    ...
    <section id="price" className="relative w-full py-20 lg:py-32 bg-peacock-dark text-cream-bg overflow-hidden px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          {/* ========================================================= */}
          {/* MOBILE NAV TABS (3 BHK / 4 BHK toggle for mobile screens) */}
          {/* ========================================================= */}
        ...
        {/* ========================================================= */}
        {/* DESKTOP VIEW: Side-by-Side 3 BHK & 4 BHK Cards */}
        {/* ========================================================= */}
        ...
        {/* ========================================================= */}
        {/* MOBILE & TABLET VIEW: Single Card Display with Active Tab */}
        {/* ========================================================= */}
            ...
            >
              ...
              {isSubmitted ? (
                <div className="py-8 text-center space-y-3">
                  ...
                  <h3 className="text-2xl font-serif text-peacock-dark">Cost Sheet Requested</h3>
                  <p className="text-sm text-peacock-dark/70 font-sans">
                    We have received your request for the <strong className="text-peacock-dark">{selectedPlan}</strong>. Our advisor will dispatch the official breakdown shortly.
                  </p>
                  <button
                    onClick={() => setIsModalOpen(false)}
